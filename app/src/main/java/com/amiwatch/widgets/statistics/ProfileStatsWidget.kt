package com.amiwatch.widgets.statistics
...
import com.amiwatch.util.BitmapUtil.downloadImageAsBitmap
import com.amiwatch.widgets.WidgetSizeProvider
...
class ProfileStatsWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun getPrefsName(appWidgetId: Int): String {
            return "com.amiwatch.widgets.Statistics.${appWidgetId}"
        }
