...
import com.amiwatch.databinding.ActivityPlayerSettingsBinding
import com.amiwatch.initActivity
import com.amiwatch.media.Media
import com.amiwatch.navBarHeight
import com.amiwatch.others.Xpandable
        ...
        binding.subtitleTestText.run {
            ...
            typeface =
                when (PrefManager.getVal<Int>(PrefName.Font)) {
                    0 -> ResourcesCompat.getFont(this.context, R.font.poppins_semibold)
                    ...
                    else -> ResourcesCompat.getFont(this.context, R.font.poppins_semibold)
                }
