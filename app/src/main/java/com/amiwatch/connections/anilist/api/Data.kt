package com.amiwatch.connections.anilist.api
...
class Query {
    ...
    data class Viewer(
        ...
        data class Data(
            @SerialName("Viewer")
            val user: com.amiwatch.connections.anilist.api.User?
        )
    }
    ...
    data class Media(
        ...
        data class Data(
            @SerialName("Media")
            val media: com.amiwatch.connections.anilist.api.Media?,
            @SerialName("Page")
            val page: com.amiwatch.connections.anilist.api.Page?
        )
    }
...
//    ){
//        data class Data(
//            val AiringSchedule: com.amiwatch.connections.anilist.api.AiringSchedule?
//        )
//    }
    ...
    data class Character(
        ...
        data class Data(
            ...
            val character: com.amiwatch.connections.anilist.api.Character?
        )
    }
    ...
    data class Studio(
        ...
        data class Data(
            @SerialName("Studio")
            val studio: com.amiwatch.connections.anilist.api.Studio?
        )
    }
...
//    ){
//        data class Data(
//            val MediaList: com.amiwatch.connections.anilist.api.MediaList?
//        )
//    }
    ...
    data class MediaListCollection(
        ...
        data class Data(
            ...
            val mediaListCollection: com.amiwatch.connections.anilist.api.MediaListCollection?
        )
    }
    ...
    data class CombinedMediaListResponse(
        ...
        @Serializable
        data class Data(
            @SerialName("current") val current: com.amiwatch.connections.anilist.api.MediaListCollection?,
            @SerialName("planned") val planned: com.amiwatch.connections.anilist.api.MediaListCollection?,
            @SerialName("repeating") val repeating: com.amiwatch.connections.anilist.api.MediaListCollection?,
        )
    }
    ...
    data class HomePageMedia(
        ...
        @Serializable
        data class Data(
            @SerialName("currentAnime") val currentAnime: com.amiwatch.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingAnime") val repeatingAnime: com.amiwatch.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteAnime") val favoriteAnime: com.amiwatch.connections.anilist.api.User?,
            @SerialName("plannedAnime") val plannedAnime: com.amiwatch.connections.anilist.api.MediaListCollection?,
            @SerialName("currentManga") val currentManga: com.amiwatch.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingManga") val repeatingManga: com.amiwatch.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteManga") val favoriteManga: com.amiwatch.connections.anilist.api.User?,
            @SerialName("plannedManga") val plannedManga: com.amiwatch.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationQuery") val recommendationQuery: com.amiwatch.connections.anilist.api.Page?,
            @SerialName("recommendationPlannedQueryAnime") val recommendationPlannedQueryAnime: com.amiwatch.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationPlannedQueryManga") val recommendationPlannedQueryManga: com.amiwatch.connections.anilist.api.MediaListCollection?,
    ...
    data class AnimeList(
        ...
        @Serializable
        data class Data(
            @SerialName("recentUpdates") val recentUpdates: com.amiwatch.connections.anilist.api.Page?,
            @SerialName("trendingMovies") val trendingMovies: com.amiwatch.connections.anilist.api.Page?,
            @SerialName("topRated") val topRated: com.amiwatch.connections.anilist.api.Page?,
            @SerialName("mostFav") val mostFav: com.amiwatch.connections.anilist.api.Page?,
        )
    }
    ...
    data class MangaList(
        ...
        @Serializable
        data class Data(
            @SerialName("trendingManga") val trendingManga: com.amiwatch.connections.anilist.api.Page?,
            @SerialName("trendingManhwa") val trendingManhwa: com.amiwatch.connections.anilist.api.Page?,
            @SerialName("trendingNovel") val trendingNovel: com.amiwatch.connections.anilist.api.Page?,
            @SerialName("topRated") val topRated: com.amiwatch.connections.anilist.api.Page?,
            @SerialName("mostFav") val mostFav: com.amiwatch.connections.anilist.api.Page?,
        )
    }
    ...
    data class FollowerPage(
        ...
        val followers: List<com.amiwatch.connections.anilist.api.User>?
    ) : java.io.Serializable

    @Serializable
    data class FollowingPage(
        @SerialName("following")
        val following: List<com.amiwatch.connections.anilist.api.User>?
    ) : java.io.Serializable
