...
import com.amiwatch.addons.torrent.TorrentServerService
import com.amiwatch.connections.anilist.Anilist
import com.amiwatch.connections.anilist.AnilistHomeViewModel
import com.amiwatch.databinding.ActivityMainBinding
import com.amiwatch.databinding.DialogUserAgentBinding
import com.amiwatch.databinding.SplashScreenBinding
import com.amiwatch.home.AnimeFragment
import com.amiwatch.home.HomeFragment
import com.amiwatch.home.LoginFragment
import com.amiwatch.home.MangaFragment
import com.amiwatch.home.NoInternet
...
import com.amiwatch.others.calc.CalcActivity
import com.amiwatch.profile.ProfileActivity
import com.amiwatch.profile.activity.FeedActivity
import com.amiwatch.profile.notification.NotificationActivity
import com.amiwatch.settings.AddRepositoryBottomSheet
import com.amiwatch.settings.ExtensionsActivity
import com.amiwatch.settings.saving.PrefManager
import com.amiwatch.settings.saving.PrefManager.asLiveBool
import com.amiwatch.settings.saving.PrefName
import com.amiwatch.settings.saving.SharedPreferenceBooleanLiveData
...
import com.amiwatch.util.AudioHelper
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                    if (!(PrefManager.getVal(PrefName.AllowOpeningLinks) as Boolean)) {
                        CustomBottomDialog.newInstance().apply {
                            title = "Allow Amiwatch to automatically open Anilist & MAL Links?"
