...
import com.amiwatch.brightnessConverter
import com.amiwatch.circularReveal
...
import com.amiwatch.databinding.ActivityExoplayerBinding
import com.amiwatch.defaultHeaders
import com.amiwatch.download.DownloadsManager.Companion.getSubDirectory
import com.amiwatch.download.video.Helper
import com.amiwatch.dp
import com.amiwatch.getCurrentBrightnessValue
import com.amiwatch.getLanguageCode
import com.amiwatch.hideSystemBars
...
import com.amiwatch.media.SubtitleDownloader
import com.amiwatch.okHttpClient
import com.amiwatch.others.AniSkip
import com.amiwatch.others.AniSkip.getType
import com.amiwatch.others.LanguageMapper
import com.amiwatch.others.ResettableTimer
import com.amiwatch.others.Xubtitle
import com.amiwatch.others.getSerialized
import com.amiwatch.parsers.AnimeSources
import com.amiwatch.parsers.HAnimeSources
import com.amiwatch.parsers.Subtitle
import com.amiwatch.parsers.SubtitleType
import com.amiwatch.parsers.Video
import com.amiwatch.parsers.VideoExtractor
import com.amiwatch.parsers.VideoType
import com.amiwatch.settings.PlayerSettingsActivity
    ...
    private fun setupSubFormatting(playerView: PlayerView) {
        ...
        val font =
            when (PrefManager.getVal<Int>(PrefName.Font)) {
                0 -> ResourcesCompat.getFont(this, R.font.poppins_semibold)
                ...
                else -> ResourcesCompat.getFont(this, R.font.poppins_semibold)
            }
