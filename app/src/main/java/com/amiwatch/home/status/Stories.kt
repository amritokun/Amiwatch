package com.amiwatch.home.status
...
import com.amiwatch.connections.anilist.api.Activity
import com.amiwatch.databinding.FragmentStatusBinding
import com.amiwatch.getThemeColor
import com.amiwatch.home.status.listener.StoriesCallback
...
import com.amiwatch.profile.UsersDialogFragment
import com.amiwatch.profile.activity.ActivityItemBuilder
import com.amiwatch.profile.activity.RepliesBottomDialog
...
import com.amiwatch.util.AniMarkdown
...
class Stories @JvmOverloads constructor(
    ...
    fun initLayout() {
        ...
        primaryColor = context.getThemeColor(com.google.android.material.R.attr.colorPrimaryFixed)
